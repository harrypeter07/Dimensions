	...
	const products = [
		{
			...
			category: "apparel",
			price: 59.99,
			description: "Premium quality hoodie with embroidered AXIS 25 2024 logo.",
			image: "/globe.svg",
		...
		},
		{
			...
			price: 79.99,
			description:
				"Spacious laptop backpack with multiple compartments and tech organizers.",
			image: "/window.svg",
		...
		},
		{
			...
			price: 24.99,
			description:
				"Exclusive set of enamel pins featuring tech-inspired designs.",
			image: "/file.svg",
		...
		},
		{
			...
			price: 29.99,
			description:
				"Comfortable and stylish t-shirt with unique tech-inspired graphics.",
			image: "/window.svg",
		...
		},
		{
			...
			price: 19.99,
			description:
				"Premium notebook with tech-themed designs and smart pen holder.",
			image: "/file.svg",
			...
			>
				<div className="mb-16 text-center">
					...
					<p className="mx-auto mt-8 max-w-3xl text-lg text-gray-300 md:text-xl">
						Take home a piece of AXIS 25 2024 with our exclusive merchandise
						collection.
					</p>
				</div>
				...
				>
					...
					<p className="mx-auto mb-8 max-w-3xl text-lg text-gray-300">
						Free shipping on orders over $100. All merchandise will be available
						for pickup at the event or shipped to your location.
					</p>
					<div className="grid grid-cols-1 gap-8 mx-auto max-w-4xl md:grid-cols-3">
						...
						<div className="p-6 rounded-xl backdrop-blur-lg bg-white/5">
							...
							<p className="text-gray-400">
								2-5 business days delivery worldwide
							</p>
						</div>
						<div className="p-6 rounded-xl backdrop-blur-lg bg-white/5">
