	...
	const partners = [
		{
			...
			description:
				"Leading technology solutions provider supporting innovation in AI and cloud computing.",
			logo: "/globe.svg",
		...
		},
		{
			...
			type: "Gold Partner",
			description:
				"Research and development firm specializing in emerging technologies and digital transformation.",
			logo: "/window.svg",
		...
		},
		{
			...
			type: "Silver Partner",
			description:
				"Digital solutions company pioneering advancements in virtual and augmented reality.",
			logo: "/file.svg",
	...
	const sponsors = [
		{
			...
			description:
				"Enterprise software development company providing development tools and resources.",
			logo: "/window.svg",
		...
		},
		{
			...
			description:
				"Cloud infrastructure provider enabling scalable and reliable event operations.",
			logo: "/globe.svg",
		...
		},
		{
			...
			type: "Event Sponsor",
			description:
				"Venture capital firm supporting technological innovation and startup growth.",
			logo: "/file.svg",
			...
			>
				...
				>
					...
					<p className="mx-auto mb-8 max-w-3xl text-lg text-gray-300">
						Join us in shaping the future of technology. Partner with AXIS 25
						2024 and be part of something extraordinary.
					</p>
					<motion.button
						whileHover={{
							scale: 1.05,
